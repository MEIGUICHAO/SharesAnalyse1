...
//    http://dcfm.eastmoney.com/em_mutisvcexpandinterface/api/js/get?callback=datatable2543375&type=HOLDERNUM&p=1&ps=3&sr=-1&sty=detail&st=EndDate&token=70f12f2f4f091e459a279469fe49eca5&filter=(securitycode%3D300059)
//    http://dcfm.eastmoney.com/em_mutisvcexpandinterface/api/js/get?type=HOLDERNUM&p=1&ps=3&sr=-1&sty=detail&st=EndDate&token=70f12f2f4f091e459a279469fe49eca5&filter=(securitycode%3D300059)
    ...
    const val dfcfUrl = "http://dcfm.eastmoney.com"
    ...
    const val HOLDER_TB = "HOLDER_TB_"
...
//    val DEBUG_Code = listOf("000006","000009","000011","000012","000025")
    val DEBUG_Code = listOf("600970","600850","600478","600598")
...
//        val DEBUG_Code = listOf("688133","300278","000544")
    ...
    const val All_Reasoning_30 = "All_Reasoning_30"
    const val All_Reasoning_50 = "All_Reasoning_50"
