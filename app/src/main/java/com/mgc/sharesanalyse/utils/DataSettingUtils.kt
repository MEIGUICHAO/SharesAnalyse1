...
//                LogUtil.d("12-->${(P_L >= it.p_L_X && P_L <= it.p_L_D)}")
    ...
    fun getInsertRevKJOCOOBean(
        ...
        revKJOCOOBean.oO3 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,0,3), originOC)
        revKJOCOOBean.oO5 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,4,5), originOC)
        revKJOCOOBean.oO10 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,6,10), originOC)
        revKJOCOOBean.oO15 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,11,15), originOC)
        revKJOCOOBean.oO20 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,16,20), originOC)
        revKJOCOOBean.oO25 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,21,25), originOC)
        revKJOCOOBean.oO30 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,26,30), originOC)
        revKJOCOOBean.oO35 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,31,35), originOC)
        revKJOCOOBean.oO40 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,36,40), originOC)
        revKJOCOOBean.oO45 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,41,45), originOC)
        revKJOCOOBean.oO50 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,46,50), originOC)
        revKJOCOOBean.oO55 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,51,55), originOC)
        revKJOCOOBean.oO60 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,56,60), originOC)
        revKJOCOOBean.oO65 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,61,65), originOC)
        revKJOCOOBean.oO70 = getOCOOPercent(mCHDDList.getMaxValueInRangeByDesc(index,66,70), originOC)
        return revKJOCOOBean
    }
