...
//                LogUtil.d("12-->${(P_L >= it.p_L_X && P_L <= it.p_L_D)}")
    ...
    fun getRevKJOCOOBean(
        ...
        val originOC = mCHDDList.getPPValueByAsc(index,0,3)
        ...
        revKJOCOOBean.oC3 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,0,3), originOC)
        revKJOCOOBean.oC5 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,4,5), originOC)
        revKJOCOOBean.oC10 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,6,10), originOC)
        revKJOCOOBean.oC15 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,11,15), originOC)
        revKJOCOOBean.oC20 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,16,20), originOC)
        revKJOCOOBean.oC25 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,21,25), originOC)
        revKJOCOOBean.oC30 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,26,30), originOC)
        revKJOCOOBean.oC35 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,31,35), originOC)
        revKJOCOOBean.oC40 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,36,40), originOC)
        revKJOCOOBean.oC45 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,41,45), originOC)
        revKJOCOOBean.oC50 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,46,50), originOC)
        revKJOCOOBean.oC55 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,51,55), originOC)
        revKJOCOOBean.oC60 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,56,60), originOC)
        revKJOCOOBean.oC65 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,61,65), originOC)
        revKJOCOOBean.oC70 = getOCOOPercent(mCHDDList.getMaxValueInRange(index,66,70), originOC)


        revKJOCOOBean.oO3 = getOCOOPercent(mCHDDList.getMinValueInRange(index,0,3), originOC)
        revKJOCOOBean.oO5 = getOCOOPercent(mCHDDList.getMinValueInRange(index,4,5), originOC)
        revKJOCOOBean.oO10 = getOCOOPercent(mCHDDList.getMinValueInRange(index,6,10), originOC)
        revKJOCOOBean.oO15 = getOCOOPercent(mCHDDList.getMinValueInRange(index,11,15), originOC)
        revKJOCOOBean.oO20 = getOCOOPercent(mCHDDList.getMinValueInRange(index,16,20), originOC)
        revKJOCOOBean.oO25 = getOCOOPercent(mCHDDList.getMinValueInRange(index,21,25), originOC)
        revKJOCOOBean.oO30 = getOCOOPercent(mCHDDList.getMinValueInRange(index,26,30), originOC)
        revKJOCOOBean.oO35 = getOCOOPercent(mCHDDList.getMinValueInRange(index,31,35), originOC)
        revKJOCOOBean.oO40 = getOCOOPercent(mCHDDList.getMinValueInRange(index,36,40), originOC)
        revKJOCOOBean.oO45 = getOCOOPercent(mCHDDList.getMinValueInRange(index,41,45), originOC)
        revKJOCOOBean.oO50 = getOCOOPercent(mCHDDList.getMinValueInRange(index,46,50), originOC)
        revKJOCOOBean.oO55 = getOCOOPercent(mCHDDList.getMinValueInRange(index,51,55), originOC)
        revKJOCOOBean.oO60 = getOCOOPercent(mCHDDList.getMinValueInRange(index,56,60), originOC)
        revKJOCOOBean.oO65 = getOCOOPercent(mCHDDList.getMinValueInRange(index,61,65), originOC)
        revKJOCOOBean.oO70 = getOCOOPercent(mCHDDList.getMinValueInRange(index,66,70), originOC)
